...
# Another key point is that if what you are studying involves randomness, make use of statistics.
...
* Completeness: this is for student’s report. I have to make sure that students do not leave some key part out. 
* correctness: We have a question (main goal). You design a proper experiment to answer it. You interpret the results correctly. This includes using proper statistics as it fits.
* statistics: this is just for this assignment. I want to emphasize it.
* readability: english and how you write a proper report.
* overall being: this is everything, including how the entire article looks (does it look like pieces roughly stitched together or does it look like a mindfully written article?)
